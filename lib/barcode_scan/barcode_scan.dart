...
class BarcodeScan4 extends StatefulWidget {
  const BarcodeScan4({Key? key}) : super(key: key);
  @override
  _BarcodeScan4State createState() => _BarcodeScan4State();
}

class _BarcodeScan4State extends State<BarcodeScan4> {
